...
function MyComponent({
  ...
  const [hoveredInstru, setHoveredInstru] = useState(false);
             ...
             <SelectTrigger className="w-full md:w-[77%]">
              ...
              <SelectContent>
                <SelectItem
                  ...
                  style={{
                    backgroundColor: hoveredInstru ? '#424142' : 'transparent',
                    transition: 'background-color 0.3s ease',
                  }}
                  onMouseEnter={() => setHoveredInstru(true)}
                  onMouseLeave={() => setHoveredInstru(false)}
                >
                  Instrumentalist
                </SelectItem>
                <SelectItem
